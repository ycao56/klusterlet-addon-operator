...
# docker manifest inspect registry.ng.bluemix.net/icp-integration/icp-platform-deploy
# ./img_move.sh registry.ng.bluemix.net mdelder registry.ng.bluemix.net icp-integration icp-platform-deploy 2.2.0
